...
function index() {
    return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            history.push(data.result.content);
        ...
        function generateVoice(userText) {
            return __awaiter(this, void 0, void 0, function () {
                var response, blob, url_1, audio, e_3;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 3, , 4]);
        ...
        function startRecording(blob) {
            return __awaiter(this, void 0, void 0, function () {
                var trans, response, e_4;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 1:
                            _a.trys.push([1, 5, , 6]);
                            trans = (0, node_fetch_1.default)(endPoint, {
                                method: "POST",
                                headers: {
                            ...
                            return [4 /*yield*/, trans];
                        case 2: return [4 /*yield*/, (_a.sent()).json()];
                        case 3:
                            response = _a.sent();
                            history.push(response.text);
                            userInput = response.text;
                            return [4 /*yield*/, genConversation(response.text)];
                        case 4:
                            _a.sent();
                            return [3 /*break*/, 6];
                        case 5:
        ...
        var formData, endPoint, history, text, audioSrc, userInput, recording, file, blob, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.trys.push([1, 5, , 6]);
                    return [4 /*yield*/, (0, node_fetch_1.default)('/api/recordAudio')];
                case 2:
                    file = _a.sent();
                    return [4 /*yield*/, file.blob()];
                case 3:
                    blob = _a.sent();
                    return [4 /*yield*/, startRecording(blob)];
                case 4:
                    _a.sent();
                    return [3 /*break*/, 6];
                case 5:
